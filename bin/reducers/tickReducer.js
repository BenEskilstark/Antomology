...
var updateBugs = function updateBugs(game) {
  ...
  try {
    for (var _iterator5 = game.WORM[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      ...
      try {
        for (var _iterator7 = collidedDirt[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
...
var updateAntLifeCycles = function updateAntLifeCycles(game) {
  ...
  try {
    for (var _iterator8 = game.EGG[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      var id = _step8.value;
  ...
  try {
    for (var _iterator9 = game.LARVA[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
  ...
  try {
    for (var _iterator10 = game.PUPA[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
...
var updatePheromones = function updatePheromones(game) {
  ...
  try {
    for (var _iterator11 = game.PHEROMONE[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
  ...
  try {
    for (var _iterator12 = toRemove[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
      var _pheromone = _step12.value;
...
var computeGravity = function computeGravity(game) {
  ...
  try {
    for (var _iterator13 = config.fallingEntities[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
      var entityType = _step13.value;
      var _iteratorNormalCompletion14 = true;
      var _didIteratorError14 = false;
      var _iteratorError14 = undefined;

      try {
        for (var _iterator14 = game[entityType][Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
...
var updateFoWVision = function updateFoWVision(game) {
  ...
  try {
    for (var _iterator15 = config.entitiesInFog[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
      ...
      try {
        for (var _iterator18 = game[entityType][Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
  ...
  try {
    for (var _iterator16 = game.ANT[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
      var _id4 = _step16.value;
  ...
  try {
    for (var _iterator17 = previouslyVisible[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
